...
col1.image("fotoange.png", caption='Esta soy yo', width=300)
...
texto_2 = """
Mi experiencia aprendiendo a programar en Python ha sido una montaña rusa. Antes de iniciar el curso tenía muchas dudas sobre los contenidos, sobre la complejidad de los temas...estaba segura de la programación no era lo mío. Pero también estaba decidida a no dejarme intimidar por esas largas cadenas de texto antes de comenzar. Hasta que un martes, comenzamos con un print('Hola Mundo') y de repente todas esas dudas se hicieron más pequeñas. Me gustó mucho aprender sobre las funciones, los bucles y el manejo de datos. Habían temas que me resultaban más sencillos y divertidos, y habían otros que me dejaban pensando por horas. Pero lo que más me gustó fue lección que me llevo de la manera en que íbamos construyendo los algoritmos. Las premisas podían verse complejas a simple vista, pero al dividirlas en partes más pequeñas y ordenar el proceso paso a paso, nos acercábamos cada vez más al objetivo, y creo que ejercitar este tipo de pensamiento es muy importante para nosotros como comunicadores.
"""
